...
# NPC IRB is a special Interactive Ruby client used by the NPC. The NPC may be able to modify the Daimoku Game World.
# Code written by the NPC, using the NPC IRB, is not viewable by the Players within the Game World.
class NPCirb < Sandbox::IRB
